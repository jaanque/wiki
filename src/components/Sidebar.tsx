  ...
  return (
    <>
      ...
      <aside className="sidebar-left" aria-label="Menú Principal">
        {/* MOBILE CLOSE HEADER */}
        <div className="sidebar-mobile-header flex items-center justify-between p-4 border-b border-gray-200 lg:hidden mb-4">
          <div className="flex items-center gap-2">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="text-blue-600"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>
            <span className="font-bold text-sm tracking-tight">wikIA Menú</span>
          </div>
          <button onClick={closeSidebar} className="p-2 -mr-2 text-gray-400 hover:text-red-600 transition-colors">
